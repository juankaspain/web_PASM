# 📸 IMÁGENES NECESARIAS - Guía Completa

**Fecha**: 2026-01-10  
**Prioridad**: 🔴 CRÍTICA  
**Estado**: BLOQUEANTE para TOP 1%

---

## ⚠️ CRÍTICO - Social Media Assets
...
- URL del sitio
- Fondo: Degradado cinematográfico (negro a azul oscuro)
...
- Buena iluminación
- Expresión neutral/seria profesional
...
## 📷 Sesión de Fotos - Especificaciones
...
4. **Galán**: Romántico, suave, atractivo
...
**Necesarias**: 20-30 fotos de producciones

**Categorías**:

1. **La Moderna** (10 fotos)
   - Escenas románticas
   - Drama intenso
   - Vestuario de época
...
4. **Teatro CNTC** (5 fotos)
   - Fuente Ovejuna
   - Oliver Twist
   - Escenario

5. **Behind the Scenes** (10 fotos)
   - En el set
   - Con directores
...
- Fotógrafo de set
- Archivo personal
- Redes sociales oficiales de las series

---

## 🎬 Video Reel - Especificaciones
...
0:30-0:50  Escena 2: Comedia/ligero (contraste)
0:50-1:10  Escena 3: Acción (Vis a vis)
1:10-1:30  Escena 4: Romántico (galán)
1:30-1:50  Escena 5: Teatro/verso clásico
1:50-2:10  Escena 6: Rango emocional
2:10-2:25  Escena 7: Momento icónico
2:25-2:40  Créditos rápidos
```
...
## 📁 Press Kit - Materiales

### Headshots para Prensa
...
AlmagroSanMiguel_Headshot_02_HiRes.jpg
...
```
...
**Uso**: Carteles, programas de mano, web
...
1. **Adobe Premiere Pro** (€24.19/mes)
   - Estándar industria
   - Completo

2. **DaVinci Resolve** (Gratis)
   - Profesional
   - Gratis versión completa
   - Color grading excepcional

3. **Final Cut Pro** (€300 one-time)
   - Mac only
   - Rápido
...
1. **Esta semana**:
   - [ ] Recopilar todas las fotos existentes
   - [ ] Contactar producción La Moderna para fotos oficiales
   - [ ] Reservar sesión headshots (1-2 semanas)

2. **Semana que viene**:
   - [ ] Sesión fotos completa
   - [ ] Seleccionar mejores takes
   - [ ] Crear OG images con Canva

3. **En 2 semanas**:
   - [ ] Recopilar clips para reel
   - [ ] Contactar editor o DIY
   - [ ] Editar reel completo

4. **En 3 semanas**:
   - [ ] Subir todo a la web
   - [ ] Testear compartir en redes
   - [ ] Verificar OG images funcionando

---

**¿Necesitas ayuda con el diseño de OG images? Puedo guiarte paso a paso con Canva.** 🎨
