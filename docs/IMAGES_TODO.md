# 🖼️ Imágenes Open Graph - Guía de Creación

## 🚨 IMPORTANTE: Estas 3 imágenes son CRÍTICAS para SEO

Sin ellas, cuando compartas la web en redes sociales (Facebook, Twitter, LinkedIn, WhatsApp), no se verá bien.
...
Formato: JPG (calidad 90%) o PNG
Peso máximo: 5 MB (recomendado <1MB)
Ratio: 16:9
Uso: Twitter Cards
```
...
Peso máximo: 200 KB
Ratio: 1:1 (cuadrado)
Uso: Google Knowledge Panel, Schema.org
```
...
|                                                  |
|  [FOTO]           ALMAGRO SAN MIGUEL             |
|  PERFIL                                          |
|  ACTOR            Actor Profesional              |
|  LATERAL          TV · Cine · Teatro              |
|  (40%)                                           |
|                   La Moderna (TVE)               |
...
Línea 3: TV · Cine · Teatro
Línea 4 (opcional): La Moderna • Vis a vis • Hernán
```
...
Fondo alternativo: #0A0A0A (Negro suave)
Texto principal: #FFFFFF (Blanco)
Acento/Marca: #FACC15 (Amarillo dorado)
Texto secundario: #94A3B8 (Gris slate)
```
...
Glow effect: rgba(250, 204, 21, 0.2) blur 100px
```
...
4. Ajustar dimensiones manualmente
...
4. Añadir texto con fuentes similares a Inter
...
3. Modo de color: RGB
4. Diseñar según especificaciones
5. Guardar como JPG optimizado
...
- ✅ Alta resolución (mínimo 2000px de ancho)
...
**Usa alguna de estas y recórtala/ajusta según necesites**
...
Alternativa 2: Montserrat (Bold)
Alternativa 3: Roboto (Bold)
```
...
Detalles "TV · Cine · Teatro": 24-28px, Regular
Proyectos: 20-24px, Light
```
...
# Copiar las imágenes a public/
cp /ruta/descarga/og-image.jpg public/
cp /ruta/descarga/twitter-image.jpg public/
cp /ruta/descarga/profile-image.jpg public/

# Commit y push
git add public/og-image.jpg public/twitter-image.jpg public/profile-image.jpg
git commit -m "feat(seo): Añadir imágenes Open Graph profesionales"
...
4. Verificar que aparece og-image.jpg correctamente
...
|  TV · Cine · Teatro                          |
+---------------------------------------------+
  almagrosanmiguel.com
  Actor con 13+ años de experiencia...
```
...
- **Opción 1 (Canva)**: 30-45 minutos
- **Opción 2 (Figma)**: 20-30 minutos (si sabes usar)
- **Opción 3 (Contratar diseñador)**: 1-2 días de espera

---

## ✅ CUANDO ESTÉN LISTAS

1. Subir las 3 imágenes a `public/`
2. Verificar en navegador:
   - `https://almagrosanmiguel.com/og-image.jpg`
   - `https://almagrosanmiguel.com/twitter-image.jpg`
   - `https://almagrosanmiguel.com/profile-image.jpg`
3. Validar con Facebook Debugger
4. Validar con Twitter Card Validator
5. Compartir la web en redes sociales para probar
6. ¡Listo! 🎉
