  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-slate-950 to-black">
      ...
      <div className="container mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
        {/* What are cookies */}
        <div className="animate-fadeInUp mb-8 rounded-2xl border border-white/10 bg-white/[0.02] p-6 lg:p-8">
        ...
        <div className="animate-fadeInUp mb-8 rounded-2xl border border-white/10 bg-white/[0.02] p-6 delay-[600ms] lg:p-8">
          <h2 className="mb-4 flex items-center gap-3 text-2xl font-bold text-white">
        ...
        {/* Third party cookies */}
        <div className="animate-fadeInUp mb-8 rounded-2xl border border-white/10 bg-white/[0.02] p-6 delay-700 lg:p-8">
        ...
        {/* Updates */}
        <div className="animate-fadeInUp rounded-2xl border border-white/10 bg-white/[0.02] p-6 delay-[800ms] lg:p-8">
        ...
        {/* CTA */}
        <div className="animate-fadeInUp mt-12 rounded-2xl border border-yellow-400/30 bg-gradient-to-br from-yellow-900/10 to-orange-900/5 p-8 text-center delay-[900ms]">
