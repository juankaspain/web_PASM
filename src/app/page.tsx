...
const LatestProject = dynamic(() => import('@/components/sections/LatestProject'), { ssr: false })
...
const Milestones = dynamic(() => import('@/components/sections/Milestones'), { ssr: false })
