  ...
  return (
    <section className="relative py-32 overflow-hidden bg-gradient-to-b from-black via-slate-950 to-slate-900">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-1/4 w-[600px] h-[600px] bg-orange-500/5 rounded-full blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 mb-8 rounded-full bg-gradient-to-r from-red-600 to-orange-600 shadow-lg"
          >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            >
              ...
              <p className="text-xl text-slate-300 mb-6 leading-relaxed">
                ...
                Estrenada en cines en octubre de 2025 y <span className="text-red-400 font-semibold">disponible en Netflix</span>.
              </p>

              <div className="mb-8 bg-white/[0.03] border border-white/10 rounded-xl p-6 backdrop-blur-sm">
                <h3 className="text-lg font-bold mb-3 text-orange-400">Reparto Destacado</h3>
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute -inset-[1px] bg-gradient-to-br from-red-500/20 to-orange-500/20 rounded-2xl blur-xl opacity-60" />
              ...
              {/* Floating badge */}
              <div className="absolute -bottom-6 -right-6 bg-gradient-to-br from-red-600 to-orange-600 text-white px-6 py-3 rounded-full font-bold shadow-xl">
                <div className="flex items-center gap-2">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              >
                <div className="absolute -inset-[1px] bg-gradient-to-br from-red-500/20 to-orange-500/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <div className="relative bg-white/[0.03] border border-white/10 rounded-2xl p-8 backdrop-blur-sm hover:bg-white/[0.05] transition-all">
                  ...
                  <div className="space-y-4 text-slate-300 leading-relaxed">
                    <p>
                      ...
                      durante más de una década. Su personaje representa <span className="text-orange-400 font-semibold">el amor incondicional</span> y 
                      el apoyo emocional en medio de una operación extremadamente peligrosa.
                    </p>
                    <p>
                      Interpreta a un hombre que debe enfrentar la decisión más difícil: <span className="text-red-400 font-semibold">dejar ir al amor 
              ...
              <motion.div
                ...
                className="relative group"
              >
                <div className="absolute -inset-[1px] bg-gradient-to-br from-yellow-500/20 to-orange-500/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <div className="relative bg-white/[0.03] border border-white/10 rounded-2xl p-8 backdrop-blur-sm hover:bg-white/[0.05] transition-all">
                  <div className="flex items-center gap-3 mb-6">
            ...
            >
              <div className="inline-block bg-white/[0.03] border border-white/10 rounded-2xl px-8 py-6 max-w-3xl backdrop-blur-sm">
                ...
                <p className="text-orange-400 font-semibold mt-4">— Almagro San Miguel</p>
              </div>
            </motion.div>
          </motion.div>
        </motion.div>
