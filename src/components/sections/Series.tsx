    ...
    >
      ...
      <div className="container relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="space-y-6">
            {projects.map((project, index) => (
              <div
                ...
                className="hover-right group cursor-pointer"
              ...
              >
                <div className="relative">
                  <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.02] shadow-2xl transition-all duration-300 hover:border-white/20 hover:bg-white/[0.04]">
                    <div className="flex flex-col lg:flex-row">
                      ...
                      <div className="flex-1 p-6 lg:p-8">
                        ...
                        <p className="mb-3 text-lg text-slate-300">
                          ...
                          {project.episodes && (
                            <span className="text-slate-500"> • {project.episodes}</span>
                          )}
                        </p>
                    ...
                    <div className="absolute bottom-0 left-0 h-[2px] w-0 bg-yellow-400 transition-all duration-[400ms] group-hover:w-full" />
                  </div>
                </div>
              </div>
            ))}
          ...
          <div
            className={`mt-16 text-center transition-all delay-[800ms] duration-[600ms] ${
      ...
      {/* Modal */}
      <div
        className={`fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-black/95 p-4 backdrop-blur-md transition-all duration-300 ${
          selectedProject ? 'opacity-100' : 'pointer-events-none opacity-0'
        }`}
        onClick={() => setSelectedProject(null)}
      >
        <div
          className={`relative my-8 w-full max-w-4xl rounded-2xl border border-white/10 bg-white/[0.03] shadow-2xl backdrop-blur-xl transition-all duration-300 ${
            selectedProject
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  {selectedProject.youtube && (
                    <a
                      ...
                      className="hover-scale inline-flex items-center justify-center gap-2 rounded-xl bg-red-600 px-6 py-3 font-bold text-white shadow-lg transition-all hover:bg-red-700 hover:shadow-xl"
                    >
                  ...
                  {selectedProject.imdb && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover-scale inline-flex items-center justify-center gap-2 rounded-xl bg-yellow-400 px-6 py-3 font-bold text-black shadow-lg transition-all hover:bg-yellow-300 hover:shadow-xl"
                    >
                  ...
                  {selectedProject.filmaffinity && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover-scale inline-flex items-center justify-center gap-2 rounded-xl px-6 py-3 font-bold shadow-lg transition-all hover:shadow-xl"
